...
app.directive('svgCircle', function () {
  return {
      ...
      '<text x="10" y="30" font-family="sans-serif" font-size="16px" fill="white" data=""></text>' +
      ...
      link: function (scope, element) {
          ...
          function (value) {
              if (value) {
                  ...
                  angular.element(element[0]).find('text').attr('data', value.amomalyText + '\xa0' + value.date);
              } else {
